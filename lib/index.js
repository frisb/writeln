(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', 'babel-runtime/helpers/classCallCheck', 'babel-runtime/helpers/createClass', 'chalk', 'debug', 'util'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, require('babel-runtime/helpers/classCallCheck'), require('babel-runtime/helpers/createClass'), require('chalk'), require('debug'), require('util'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, global.classCallCheck, global.createClass, global.chalk, global.debug, global.util);
		global.index = mod.exports;
	}
})(this, function (module, _classCallCheck2, _createClass2, chalk, debug, util) {
	'use strict';
	...
	var Writeln = function () {
		function Writeln(category) {
			(0, _classCallCheck3.default)(this, Writeln);
		...
		(0, _createClass3.default)(Writeln, [{
			key: 'info',
